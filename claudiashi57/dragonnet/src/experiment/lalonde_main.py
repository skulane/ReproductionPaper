...
from experiment.lalonde_data import *
...
def run_lalonde(data_base_dir='/Users/claudiashi/data/ihdp_csv', output_dir='~/result/ihdp/',
...
def turn_knob(data_base_dir='/Users/claudiashi/data/test/', knob='dragonnet',
              output_base_dir=''):
    print("[knob]Value knob : ", knob)
    print("[knob]Database dir : ", data_base_dir)
    print("[knob]Result dir : ", output_base_dir)
    output_dir = os.path.join(output_base_dir, knob)
    print("[knob]otput_dir : ", output_dir)
    if knob == 'dragonnet':
        run_lalonde(data_base_dir=data_base_dir, output_dir=output_dir, dragon='dragonnet')

    if knob == 'tarnet':
        run_lalonde(data_base_dir=data_base_dir, output_dir=output_dir, dragon='tarnet')

    if knob == 'nednet':
        run_lalond(data_base_dir=data_base_dir, output_dir=output_dir, dragon='nednet')
...
def main():
    ...
    print("Value knob : ", args.knob)
    print("Database dir : ", args.data_base_dir)
    print("Result dir : ", args.output_base_dir)
